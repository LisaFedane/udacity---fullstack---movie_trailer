...
butch = media.Movie("Butch Cassidy and the Sundance Kid", "The story of Wild West outlaws" 
...
hero = media.Movie ("Hero", "A story of Jing Ke's assassination attempt on the Chinese "
...
arrival = media.Movie ("Arrival", "A story of a linguist enlisted by the US Army to "
...
amelie = media.Movie ("Amelie", "A whimsical Parisian movie about a shy waitress who "
...
usual = media.Movie ("The Usual Suspects", "A small time con man tells a police "
...
water = media.Movie ("Like Water for Chocolate", "The story of a girl born youngest of "
