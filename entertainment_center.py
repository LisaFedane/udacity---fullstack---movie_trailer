...
# This links to the media file and inputs specifics of each of the movies in
# this order: Title, Summary, Art, Youtube trailer
howls = media.Movie(
...
# This links to the media file & designates the displayed order of the movies.
movies = [howls, hero, arrival, amelie, usual, water,  butch]

# This links to the fresh_tomoato file that provides html/css format
# of the content.
